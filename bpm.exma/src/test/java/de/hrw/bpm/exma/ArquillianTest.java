...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "bpm.exma";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "bpm.exma.war")
            ...
            .addPackages(false, "de.hrw.bpm.exma") // not recursive to skip package 'nonarquillian'
